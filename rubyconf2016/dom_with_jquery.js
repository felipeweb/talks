...
$packages["github.com/gopherjs/jquery"] = (function() {
	var $pkg = {}, $init, js, JQuery, JQueryCoordinates, sliceType, funcType$1, mapType, sliceType$1, funcType$2, funcType$3, ptrType, sliceType$2, NewJQuery;
	js = $packages["github.com/gopherjs/gopherjs/js"];
...
$packages["main"] = (function() {
	var $pkg = {}, $init, jquery, sliceType, main;
	jquery = $packages["github.com/gopherjs/jquery"];
	sliceType = $sliceType($emptyInterface);
	main = function() {
		var $ptr;
		jquery.NewJQuery(new sliceType([])).Ready((function() {
			var $ptr;
			jquery.NewJQuery(new sliceType([new $String("body")])).SetCss(new sliceType([new $String("background-color"), new $String("red")]));
			jquery.NewJQuery(new sliceType([new $String("body")])).Append(new sliceType([new $String("<img src=\"gopher.png\"/>")]));
		}));
	};
	$init = function() {
		$pkg.$init = function() {};
...
//# sourceMappingURL=dom_with_jquery.js.map
